...
def Liste_direction(request):
    ...
    context ={'myFilter':myFilter,'listedirection': directions}
...
def detail_direction(request,pk):
    ...
    context = {'myFilter':myFilter,'detaildirection':direction,'listematerieldir':materieldir,'totmaterieldir':cptmaterieldir,'totokmaterieldir':cptokmaterieldir,'totnokmaterieldir':cptnokmaterieldir}
